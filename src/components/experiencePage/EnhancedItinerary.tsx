    ...
    <div className={cn("py-8 sm:py-12", className)}>
      <div className="max-w-full mb-8 sm:mb-12">
        <div className="inline-flex items-center px-2 sm:px-3 py-1 bg-light-gray rounded-md border border-ocean-blue/20">
          ...
          <span className="text-xs sm:text-sm font-medium text-midnight-blue">
            Travel Itinerary
          </span>
        </div>
        ...
        <p className="mt-2 sm:mt-3 text-sm sm:text-base text-gray-600">
          Experience your meticulously planned adventure, with every moment
          thoughtfully arranged for an unforgettable journey
        </p>
      </div>
          ...
          >
            <div className="flex items-start gap-6 sm:gap-8">
              ...
              <div className="w-10 xs:w-14 sm:w-16 md:w-20 relative z-10">
                <div
                  className={`h-10 w-10 xs:h-14 xs:w-14 sm:h-16 sm:w-16 md:h-20 md:w-20 bg-white border-2 border-ocean-blue shadow-sm rounded-lg overflow-hidden absolute left-1/2 -translate-x-1/2 ${
                    dayIndex !== 0 && "top-[70px]"
                  }`}
                >
                  <div className="h-1/3 bg-ocean-blue flex items-center justify-center">
                    <span className="text-[8px] xs:text-[10px] sm:text-xs text-white uppercase font-medium tracking-wide">
                      Day
                    </span>
                  </div>
              ...
              <div className="flex-1 bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden">
                <div className="px-3 xs:px-4 sm:px-6 py-3 sm:py-5 border-b border-gray-200 bg-light-gray">
                  <h3 className="text-base xs:text-lg sm:text-xl font-medium text-midnight-blue line-clamp-1">
                    {day.name}
                  </h3>
                  <p className="text-xs sm:text-sm text-gray-600 mt-0.5 sm:mt-1">
                    {day.activities.length} activities •{" "}
                    {day.activities.reduce(
                      (acc, curr) => (curr.time ? acc + 1 : acc),
                      0
                    )}{" "}
                    scheduled times
                  </p>
