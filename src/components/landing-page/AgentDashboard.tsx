              ...
              <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
                ...
                <div className="bg-midnight-blue text-white p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-xl font-bold font-raleway">Agent Dashboard</h3>
                ...
                <div className="p-6 pt-0">
                  ...
                  <p className="text-sm text-gray-600 mt-2">Revenue Trend (Last 7 days)</p>
                </div>

                {/* Recent Messages */}
                <div className="p-6 pt-0 border-t border-gray-100">
                  <h4 className="font-semibold text-charcoal mb-3">Recent Messages</h4>
                  <div className="space-y-3">
                    {[
                      { name: "John D.", message: "Question about the Alps tour...", time: "2m" },
                      { name: "Maria S.", message: "Booking confirmation needed", time: "1h" }
                    ].map((msg, index) => (
          ...
          >
            <div className="mb-8">
              ...
              <p className="text-xl text-charcoal font-geist">
                Everything you need to manage and grow your travel business in one powerful dashboard.
              </p>
            </div>
            ...
            <div className="flex items-center gap-6 mb-8">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-blue-700">Secure Payouts</span>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-midnight-blue text-white px-8 py-4 rounded-lg font-semibold hover:bg-midnight-blue/90 transition-colors flex items-center justify-center gap-2">
                <Star size={20} />
                Start Agent Trial
              </button>
              <button className="border-2 border-midnight-blue text-midnight-blue px-8 py-4 rounded-lg font-semibold hover:bg-midnight-blue/5 transition-colors">
