...
export default function LivePreview({ formData, currentStep, setActiveTierIndex, activeTierIndex }: LivePreviewProps) {
  ...
  let gigImage = formData.gigImage
    ...
    <div className="bg-white rounded-xl shadow-sm p-4 md:p-6 overflow-hidden">
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {currentStep === 2 && (
            <StepTwo
            destinations={destinations} itemVariants={itemVariants}
