              ...
              <div className="p-4 md:p-6 space-y-4 md:space-y-6">
                ...
                <div className="flex items-center space-x-2 text-charcoal">
                  ...
                  <span className="text-sm">
                    {tiers[activeTierIndex]?.members || 1} members
                  </span>
                </div>
            ...
            {requirements.length > 0 && requirements[0] !== "" ? (
                ...
                (req: string, index: number) =>
                  req && (
                    ...
                    >
                      ...
                      <span className="text-base text-charcoal flex-1">
                        {req}
                      </span>
                    </motion.div>
                  )
              ...
              <>
                {[1, 2, 3].map((_, index) => (
                  <div
                    key={index}
                    className="flex items-start space-x-3 p-4 bg-gray-50 rounded-lg animate-pulse"
                  >
