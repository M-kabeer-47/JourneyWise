...
export default function IllustrationSection() {
  return (
    <div className="h-screen w-full bg-[#f0f5eb] relative overflow-hidden flex flex-col rounded-lg shadow-lg">
      {/* Background with illustration */}
      <div className="absolute inset-0 ">
        <Image
          src="/hero.avif" // Replace with a modern travel illustration
      ...
      {/* Booking Form Text in a card-like container */}
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, delay: 0.3 }}
        className="absolute top-[35%] right-16 max-w-md z-20"
      >
        <div className="bg-white/70 backdrop-blur-[1px] rounded-2xl p-8 shadow-xl">
          ...
          <h2 className="text-[32px] font-bold text-midnight-blue leading-tight mb-3">
