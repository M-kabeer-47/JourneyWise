      ...
      <div className="bg-white rounded-xl p-10 text-center border border-gray-200">
        <div className="mx-auto w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mb-4">
          ...
          >
            ...
            />
            <path
              d="M16.24 7.76C14.07 5.59 10.07 5.59 7.90002 7.76"
              stroke="#9CA3AF"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M7.90002 16.24C10.07 18.41 14.07 18.41 16.24 16.24"
              stroke="#9CA3AF"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
            ...
            />
            <path
              d="M3.14001 20.86L8.79002 15.21"
              stroke="#9CA3AF"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
    ...
    >
      {experiences.map((experience) => (
        <motion.div key={experience.id} variants={itemVariants}>
          <ExperienceCard experience={experience} isAgent={isAgent} />
        </motion.div>
      ))}
    </motion.div>
  );
