...
export default function AgentRegistration() {
  return (
    <section className=" relative top-[140px]">
      <div className="max-w-[1400px] mx-auto sm:px-0 px-4 py-12 sm:py-16  md:py-24">
          ...
          <div className="flex flex-col lg:flex-row">
            <div className="lg:w-1/2 relative min-h-[500px] xl:min-h-[700px] ">
              ...
              <div className="absolute bottom-0 left-0 p-6 sm:p-8">
                ...
                <p className="text-white text-base sm:text-lg">
                  Become a part of the fastest-growing travel community
                </p>
              </div>
            </div>
            <div className="lg:w-1/2 p-6 sm:p-8 lg:p-12 xl:p-16 bg-midnight-blue flex flex-col justify-between">
              <div>
                ...
                >
                  Transform your passion for travel into a thriving business. As
                  a JourneyWise agent, you'll create unique experiences, set
                  your own rates, and connect with adventure-seekers worldwide.
                  Our platform provides the tools and support you need to
                  succeed in the global travel market.
                </motion.p>
                <motion.div
                ...
                >
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-white opacity-80 text-xs sm:text-sm">
                      Connect with travelers worldwide and expand your business
                    </p>
                  </div>
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-white opacity-80 text-xs sm:text-sm">
                      Set your rates and receive secure, timely payments
                    </p>
                  </div>
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-white opacity-80 text-xs sm:text-sm">
                      Access intuitive booking and management features
                    </p>
                  </div>
                </motion.div>
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        ...
                        <motion.div className="flex flex-col items-center text-center relative z-10">
                          ...
                          <p className="text-white/70 text-xs px-2">
                            Sign up and showcase your expertise as a travel
                            agent
                          </p>
                        </motion.div>
                        ...
                        <motion.div className="flex flex-col items-center text-center relative z-10">
                          ...
                          <p className="text-white/70 text-xs px-2">
                            Craft unique journeys that showcase your travel
                            expertise
                          </p>
                        </motion.div>
                        ...
                        <motion.div className="flex flex-col items-center text-center relative z-10">
                          ...
                          <p className="text-white/70 text-xs px-2">
                            Receive secure payments when travelers book your
                            experiences
                          </p>
                        </motion.div>
                      </div>
                ...
                >
                  ...
                  <div className="border-t border-white/10 pt-6">
                    <div className="flex items-start">
                      <span className="text-4xl text-accent leading-none font-serif mr-3">
                        "
                      </span>
                      <div>
                        <p className="italic text-white opacity-90 text-sm">
                          JourneyWise transformed how I share my passion for
                          travel with clients from around the world.
                        </p>
                        <p className="text-accent text-sm mt-2">
                          — Maria P., Cultural Tour Guide
                        </p>
                      </div>
                    </div>
                  </div>
