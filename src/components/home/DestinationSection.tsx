...
export default function TravelDestinations() {
  ...
  return (
    <div className="relative top-[50px]" ref={sectionRef}>
       <motion.h2 
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-8 top-[60px] md:top-[0px]  ">
            <motion.h2
              ...
              className="text-5xl md:text-7xl font-bold mb-4 text-center relative max-[440px]:top-[30px]"
            >
              {destination.name}
            </motion.h2>
            <motion.p
              ...
              className="text-2xl md:text-3xl mb-8 text-center relative max-[440px]:top-[20px]"
            >
              {destination.tagline}
            </motion.p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-4xl max-[768px]:flex max-[768px]:flex-wrap max-[768px]:justify-between max-[768px]:gap-y-[2px] relative max-[440px]:top-[20px] mb-[10px]">
