...
const gigs = [
  {
    ...
    description: "Capture the beauty of Paris with a professional photographer",
    price: 150,
    image: "/paris.jpg",
    user: { name: "Sophie Dubois", image: "/user1.jpg" },
    rating: 4.8,
    reviews: 120,
    highlights: [
  ...
  },
  {
    ...
    price: 120,
    image: "/tokyo.jpg",
    user: { name: "Hiroshi Tanaka", image: "/user2.jpg" },
    rating: 4.9,
    reviews: 85,
    highlights: ["5 food stops", "Local guide", "Sake tasting"],
  },
  {
    id: 3,
    title: "New York City Walking Tour",
    description: "Discover the hidden gems of NYC on foot",
    price: 80,
    image: "/nyc.jpg",
    user: { name: "Emily Johnson", image: "/user3.jpg" },
    rating: 4.7,
    reviews: 150,
    highlights: [
  ...
  },
  {
    ...
    description: "Relax and rejuvenate in beautiful Bali",
    price: 200,
    image: "/bali.jpg",
    user: { name: "Made Surya", image: "/user4.jpg" },
    rating: 5.0,
    reviews: 75,
    highlights: [
      "Daily yoga sessions",
...
export default function RecommendedGigs() {
  ...
  const nextSlide = () => {
    setCurrentIndex(
      (prevIndex) => (prevIndex + 1) % Math.ceil(gigs.length / 3)
    );
  };
  ...
  const prevSlide = () => {
    setCurrentIndex(
      (prevIndex) =>
        (prevIndex - 1 + Math.ceil(gigs.length / 3)) %
        Math.ceil(gigs.length / 3)
    );
  };
