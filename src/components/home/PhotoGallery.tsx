...
const photos = [
  ...
  },
  {
    ...
    alt: "Man on a cliff overlooking the ocean",
    aspectRatio: "16/9",
  },
  {
    ...
    alt: "Man looking at map on mountain top",
    aspectRatio: "4/3",
  },
  {
    src: "https://images.unsplash.com/photo-1530521954074-e64f6810b32d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    alt: "Man on a boat in crystal clear water",
    aspectRatio: "16/9",
  },
  {
    ...
    alt: "Man walking on a suspension bridge in the forest",
    aspectRatio: "16/9",
  },
  {
    src: "https://images.unsplash.com/photo-1507608616759-54f48f0af0ee?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80",
    alt: "Man standing in front of Colosseum",
    aspectRatio: "3/4",
  },
];
...
export default function PhotoGallery() {
  ...
  return (
    <div
      ref={galleryRef}
      className="w-full  py-16  w-full  text-white mt-[150px]"
    >
...
function GalleryImage({
  ...
  return (
    <div
      className={`gallery-image relative w-full ${
        fullHeight ? "h-full" : "h-0 pb-[66.67%]"
      } overflow-hidden rounded-lg shadow-md transition-all duration-300 ease-in-out hover:shadow-lg hover:scale-[1.02]`}
    >
      <Image
        src={photo.src}
        alt={photo.alt}
