...
export default function TripDetail() {
  ...
  const {
    ...
    isFetching,
    isError,
  } = useFetchTrip({ id: params.id as string });
  ...
  if (fetchedData.trip) {
    startLocation =
      fetchedData.trip.waypoints.find((w: Waypoint) => w.type === "start")
        ?.name || "Start";
    endLocation =
      fetchedData.trip.waypoints.find((w: Waypoint) => w.type === "end")
        ?.name || "End";
  } else {
    return;
  }
  ...
  return (
    <div className="h-auto flex flex-col bg-light-gray font-sans mb-[100px] relative top-[60px]">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-charcoal hidden sm:block">
              {new Date(fetchedData.trip.createdAt).toLocaleDateString(
                "en-US",
                {
                  year: "numeric",
                  month: "long",
      ...
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        >
          ...
          <div className="mt-8 space-y-[300px]">
            {fetchedData.trip.waypoints.map(
      ...
      <ImageModal
        ...
        imageUrl={
          fetchedData.trip.waypoints[activeWaypointIndex].imageUrl || ""
        }
      />
