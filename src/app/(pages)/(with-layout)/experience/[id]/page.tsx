...
import { FileText, Compass, Check } from "lucide-react";
import { notFound } from "next/navigation";
import axios from "axios";
import EnhancedTravelHeader from "@/components/experiencePage/EnhancedTravelHeader";
import EnhancedLocationInfo from "@/components/experiencePage/EnhancedLocationInfo";
import EnhancedCategoryTags from "@/components/experiencePage/EnhancedCategoryTags";
import EnhancedDescriptionCard from "@/components/experiencePage/EnhancedDescriptionCard";
import EnhancedServicesList from "@/components/experiencePage/EnhancedServicesList";
import EnhancedItinerary from "@/components/experiencePage/EnhancedItinerary";
import BookingCTA from "@/components/experiencePage/BookingCTA";
import PricingTier from "@/components/experiencePage/PricingTier";
import MainImage from "@/components/experiencePage/MainImage";
import ImagesCarousel from "@/components/experiencePage/ImagesCarousel";
import ReviewSection from "@/components/experiencePage/ReviewSection";
import { reviews } from "@/lib/constants/dashboardMockData";

let isLoading = true;
async function fetchExperienceData(id: string) {
  try {
...
export default async function TripPage({ params }: { params: { id: string } }) {
  ...
  const experienceData = await fetchExperienceData(Params.id);
  ...
  return (
    <>
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-[1600px] mx-auto px-2  relative">
          {/* Header Section */}
