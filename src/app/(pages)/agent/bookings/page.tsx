...
import { Calendar, ListFilter, AlertCircle, CheckCircle, Clock } from 'lucide-react';
...
export default function BookingsPage() {
  ...
  // State
  const [statusFilter, setStatusFilter] = useState(current.get("status") || "all");
      ...
      <div className="bg-gradient-to-r from-midnight-blue to-ocean-blue text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Manage Bookings</h1>
            ...
            <div className="mt-4 md:mt-0 flex space-x-3">
              <button className="inline-flex items-center px-4 py-2 bg-white text-midnight-blue font-medium rounded-lg shadow-sm hover:bg-gray-50 transition-colors">
                <Calendar className="mr-2 h-5 w-5" />
                Calendar View
              </button>
              <button className="inline-flex items-center px-4 py-2 bg-ocean-blue/20 text-white hover:bg-ocean-blue/30 font-medium rounded-lg transition-colors">
        ...
        {isLoading ? (
          ...
          <div className="bg-white shadow rounded-lg p-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-1">Unable to load bookings</h3>
          ...
          <BookingsTable 
            bookings={bookings} 
            title={`${statusFilter === 'all' ? 'All' : statusFilter.charAt(0).toUpperCase() + statusFilter.slice(1)} Bookings`}
            isFullPage={true} 
          />
        ) : (
          // Empty state
