...
export const experiences: Experience[] = [
  {
    ...
    description: 'Explore the ancient temples and traditional tea houses of Kyoto.',
    experienceImage: 'https://images.pexels.com/photos/1440476/pexels-photo-1440476.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    location: {
      city: 'Kyoto',
      country: 'Japan'
    },
  ...
  },
  {
    id: 'e2',
    title: 'Bali Retreat',
    description: 'Relax and rejuvenate in the peaceful settings of Bali with yoga and meditation.',
    experienceImage: 'https://images.pexels.com/photos/3225531/pexels-photo-3225531.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    location: {
      city: 'Ubud',
      country: 'Indonesia'
    },
  ...
  },
  {
    ...
    description: 'Taste the authentic flavors of Catalonia with our expert food guides.',
    experienceImage: 'https://images.pexels.com/photos/3622643/pexels-photo-3622643.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    location: {
      city: 'Barcelona',
      country: 'Spain'
    },
  ...
  },
  {
    ...
    experienceImage: 'https://images.pexels.com/photos/2506923/pexels-photo-2506923.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    location: {
      city: 'Tokyo',
      country: 'Japan'
    },
...
export const reviews: Review[] = [
  {
    ...
    comment: 'This tour exceeded all my expectations! Our guide was incredibly knowledgeable about Kyoto\'s history.',
    rating: 5,
  ...
  },
  {
    ...
    userImage: 'https://images.pexels.com/photos/1222271/pexels-photo-1222271.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    comment: 'The retreat was exactly what I needed. Beautiful location and great instructors.',
    rating: 4.5,
  ...
  },
  {
    ...
    comment: 'Amazing food and fantastic guide! I discovered so many hidden gems in Barcelona.',
    rating: 5,
